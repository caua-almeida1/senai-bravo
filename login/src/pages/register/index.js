...
import Back from "../../img/undraw_access_account_re_8spm.svg"
...
return(
    ...
    <div className="container d-flex justify-content-center align-items-center min-vh-100">
        ...
        <div className="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
            ...
            <p className="text-white fs-4" style={{ fontWeight: "550" }}>Faça Seu Cadastro</p>
        ...
        <div className="col-md-6 right-box">
            <div className="row align-items-center">
                <div className="header-text mb-4">
                    ...
                    <p>Estamos felizes por tê-lo aqui.</p>
                </div>
                <div className="input-group mb-3">
                    <input type="text" className="form-control form-control-lg bg-light fs-6" placeholder="Digite Seu nome..." name= "name" onChange={valueInput} />
                </div>
                <div className="input-group mb-3">
                ...
                <div className="input-group mb-3">
                    ...
                    <button className="btn btn-lg btn-primary w-100 fs-6 loginBtn" type="submit">Cadastre-se</button>
                </div>
                <div className="input-group mb-3">
                ...
                <div className="row">
                    <small>Já possui uma conta?  <a href="/">Faça Seu Login</a></small>
                </div>
            </div>
        </div>
        </div>
